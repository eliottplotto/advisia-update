...
export default async function ArticlePage({ params }: Props) {
  ...
  return (
    <main className="relative">
      ...
      <article>
        {/* ─── HERO ARTICLE — centré, sans image ────────────────── */}
        <section
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            {/* Title */}
            <h1
              className="text-[2.2rem] sm:text-4xl md:text-5xl lg:text-[3.6rem] font-black leading-[1.05] tracking-[-0.025em] mb-8"
            ...
            {article.excerpt && (
              <p
                className="text-lg md:text-xl lg:text-[1.35rem] font-light italic leading-[1.4] mb-10"
                style={{
