...
export default async function FeaturedProjectScreen() {
  ...
  return (
    <section className="flex flex-col justify-center items-end relative h-screen">
      <Image
      ...
      <div className="relative z-1 container grid grid-cols-4 gap-2">
        <div className="col-span-4 md:col-span-3 md:col-end-5 lg:col-span-2 lg:col-end-5">
